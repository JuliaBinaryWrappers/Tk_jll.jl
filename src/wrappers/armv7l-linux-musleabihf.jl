# Autogenerated wrapper script for Tk_jll for armv7l-linux-musleabihf
export libtk, wish
...
"""
function __init__()
    global artifact_dir = abspath(artifact"Tk")
    ...
    foreach(p -> append!(PATH_list, p), (Tcl_jll.PATH_list, Xorg_libXft_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (Tcl_jll.LIBPATH_list, Xorg_libXft_jll.LIBPATH_list,))

    global libtk_path = normpath(joinpath(artifact_dir, libtk_splitpath...))
    ...
    global wish_path = normpath(joinpath(artifact_dir, wish_splitpath...))
